...
- `gfold-core/` - Rust implementation solving the SOCP directly with Clarabel ([README](gfold-core/README.md))
...
- For the Rust solver, see [gfold-core README](gfold-core/README.md)
